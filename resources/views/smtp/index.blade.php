    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white p-4 rounded-lg shadow-sm">
                <form action="{{ route('smtp.index') }}" method="GET" class="flex items-center space-x-4">
                    <div class="flex-grow">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" id="search" value="{{ request('search') }}" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="Search SMTP configs...">
                        </div>
                    </div>
                    <div>
                    ...
                    @if(request('search'))
                    <div>
                        <a href="{{ route('smtp.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Clear
                        </a>
                    </div>
                    @endif
