        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('smtp.store') }}">
                    ...
                    <div class="mb-6 p-4 border border-gray-200 rounded-lg bg-gray-50" x-data="{ bounceEnabled: {{ old('bounce_check_enabled', 'false') }} }">
                        ...
                        <div x-show="bounceEnabled" x-cloak class="space-y-4 ml-6 pl-4 border-l-2 border-indigo-200">
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="imap_host" name="imap_host" type="text" class="mt-1 block w-full" :value="old('imap_host')" placeholder="imap.gmail.com" />
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="imap_folder" name="imap_folder" type="text" class="mt-1 block w-full" :value="old('imap_folder', 'INBOX')" />
