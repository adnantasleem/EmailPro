            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('smtp.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="daily_limit" name="daily_limit" type="number" class="mt-1 block w-full" :value="old('daily_limit', 500)" required min="1" max="100000" />
                        <p class="mt-1 text-sm text-gray-500">Maximum emails to send per day through this SMTP</p>
